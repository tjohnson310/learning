...
urlpatterns = [
    ...
    path("delete_comment/<str:listing_id>/<str:user>/<str:comment>", views.delete_comment, name="delete_comment"),
    ...
    path("submit_bid_edit/<int:bid_id>/", views.submit_bid_edit, name="submit_bid_edit")
]
